...
namespace MasterUserMVC.Controllers {
  ...
  public class AccountController : Controller {
    ...
    public async Task<ActionResult> Login(LoginViewModel model, string returnUrl) {
      ...
      // var u = UserManager.IsInRole(User.Identity.GetUserId(), "Admin");
      //IList<string> roles;
      //        string[] roleNames = Roles.GetRolesForUser();
      //roles = await UserManager.GetRolesAsync(model.Email);
      //    var asda= await  UserManager.IsInRoleAsync(model.Email,"Admin");
    ...
    private void addToCache(LoginViewModel model) {
      ...
      if (HttpRuntime.Cache["LoggedInUsers"] != null) 
        ...
        //add this user to the list
                 if (!loggedInUsers.Contains(model.Email))
                 {
    ...
    public ActionResult LogOff() {
      removeFromCache(User.Identity.Name);
